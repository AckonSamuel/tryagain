...
class ClubStaffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create club_staff" do
    assert_difference("ClubStaff.count") do
      post club_staffs_url, params: { club_staff: { club_id: @club_staff.club_id, staff_id: @club_staff.staff_id } }, as: :json
    end
  ...
  test "should update club_staff" do
    patch club_staff_url(@club_staff), params: { club_staff: { club_id: @club_staff.club_id, staff_id: @club_staff.staff_id } }, as: :json
    assert_response :success
  end
