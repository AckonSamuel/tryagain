...
class ClubStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create club_student" do
    assert_difference("ClubStudent.count") do
      post club_students_url, params: { club_student: { club_id: @club_student.club_id, student_id: @club_student.student_id } }, as: :json
    end
  ...
  test "should update club_student" do
    patch club_student_url(@club_student), params: { club_student: { club_id: @club_student.club_id, student_id: @club_student.student_id } }, as: :json
    assert_response :success
  end
